          ...
          <div className="flex w-full justify-between items-center h-[50px] text-slate-500">
            <ul className="flex justify-start items-center gap-8">
              ...
              >
                ...
                <span>bengaldeli@gmail.com</span>
              </li>
              <span>multivendor ecommerce</span>
            </ul>
            <div>
              <div className="flex justify-center items-center gap-10">
                ...
                <div
                  className="flex group cursor-pointer text-slate-800 text-sm justify-center items-center gap-1 relative 
                  after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px] after:absolute before:absolute before:h-[18px] before:bg-[#afafaf] before:w-[1px] before:-left-[20px]"
                >
          ...
          <div className="h-[80px] md-lg:h-[100px] flex justify-between items-center flex-wrap">
            <div className="md-lg:w-full w-3/12 md-lg:pt-4">
              <div className="flex justify-between items-center">
                <Link to="/">
                  <img
                    className="h-[75px] w-[250px] ml-20 md-lg:ml-10"
                    src="/images/logo.png"
                    alt="logo"
                  />
                </Link>
                ...
                <ul className="flex justify-start items-start gap-8 text-sm font-bold uppercase md-lg:hidden">
                  <li>
                    <Link
                      to="/"
                      className={`p-2 block ${
                        pathname === '/' ? 'text-black' : 'text-slate-500'
                      }`}
                    >
                      Home
                    </Link>
                  ...
                  <li>
                    <Link
                      to="/shops"
                      className={`p-2 block ${
                        pathname === '/shop' ? 'text-black' : 'text-slate-500'
                      }`}
                    >
                      Shop
                    </Link>
                  ...
                  <li>
                    <Link
                      className={`p-2 block ${
                        pathname === '/blog' ? 'text-black' : 'text-slate-500'
                      }`}
                    >
                      Blog
                    </Link>
                  ...
                  <li>
                    <p
                      className={`p-2 block ${
                        pathname === '/login_seller'
                          ? 'text-black'
                          : 'text-slate-500'
                      }`}
                    >
                      <div>
                        <a target="__blank" href="http://localhost:3001/login">
                          become a seller
                        </a>
                      </div>
                    </p>
          ...
          <div className="flex justify-start flex-col gap-6">
            ...
            <ul className="flex flex-col justify-start items-start text-md font-semibold uppercase">
              ...
              <li>
                <Link
                  className={`py-2 block ${
                    pathname === '/contact' ? 'text-black' : 'text-slate-500'
                  }`}
                >
                  Contact
                </Link>
          ...
          <div className="w-3/12 md-lg:w-full">
            <div className="bg-white relative">
              <div
                ...
                className="h-[50px] w-[200px] bg-[#eeeeee] text-black flex justify-center md-lg:justify-between md-lg:px-6 items-center gap-3 font-bold text-md cursor-pointer"
              >
                ...
                <ul className="py-2 text-slate-600 font-medium h-full overflow-auto">
                  {categorys.map((c, i) => {
                    return (
                      <li
                        key={i}
                        className="flex justify-center items-center gap-2 px-[2px] py-[6px]"
                      >
                        <img
                          src={c.image}
