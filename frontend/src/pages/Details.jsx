...
const Details = () => {
  ...
  return (
    <div>
      <Headers />
      <div className='bg-[url("http://localhost:3000/images/banner/order.jpg")] h-[300px] mt-6 bg-cover bg-no-repeat relative bg-left '>
        <div className="absolute left-0 top-0 w-full h-full bg-[#2422228a] ">
          <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto ">
            <div className="flex flex-col justify-center items-center gap-1 h-full w-full text-white">
              <h2 className="text-3xl font-bold">Bengaldeli.com</h2>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="flex gap-3 pb-10 border-b">
                ...
                <div>
                  <div
                    ...
                    className="h-[50px] w-[50px] flex justify-center items-center cursor-pointer hover:shadow-lg hover:gray-red-500/40 bg-gray-500 text-white"
                  >
                    <AiFillHeart />
                  </div>
                </div>
              ...
              <div className="pr-4 md-lg:pr-0">
                ...
                <div>
                  {state === 'reviews' ? (
                    ...
                    <p className="py-5 text-slate-500">{product.description}</p>
                  )}
                </div>
              </div>
            </div>
                  ...
                  return (
                    <Link className="block">
                      ...
                      <div className="flex gap-2">
                        <h2 className="text-[#ff4545] text-lg font-bold">
                          ${p.price}
                        </h2>
                    ...
                    <Link className="block">
                      <div className="relative h-[270px]">
                        <div className="w-full h-full">
                          <img
                            ...
                            alt=""
                          />
                          <div className="flex absolute h-full w-full top-0 left-0 bg-[#000] opacity-25 hover:opacity-50 transition-all duration-500"></div>
                        </div>
                      ...
                      <div className="flex flex-col gap-1 p-4">
                        ...
                        <div className="flex justify-start items-center gap-3">
                          <h2 className="text-[#fc3f3f] text-lg font-bold">
                            ${p.price}
                          </h2>
                          <div className="flex">
                            <Ratings ratings={p.rating} />
