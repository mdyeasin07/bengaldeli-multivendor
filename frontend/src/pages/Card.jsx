...
const Card = () => {
  ...
  return (
    <div>
      <Headers />
      <section className='bg-[url("http://localhost:3000/images/banner/card.jpg")] h-[300px] mt-6 bg-cover bg-no-repeat relative bg-left '>
                            ...
                            <div className="flex justify-between w-5/12 sm:w-full sm:mt-3">
                              ...
                              <div className="flex gap-2 flex-col">
                                <div className="flex bg-slate-200 h-[30px] justify-center items-center text-xl">
                                  <div
                                    onClick={() => dec(pr.quantity, pr._id)}
                                ...
                                <button
                                  onClick={() =>
                                    dispatch(delete_card_product(pr._id))
                                  }
              ...
              <div className="w-[33%] md-lg:w-full">
                <div className="pl-3 md-lg:pl-0 md-lg:mt-5">
                  {card_products.length > 0 && (
                    <div className="bg-white p-3 text-slate-600 flex flex-col gap-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        />
                        <button className="px-5 py-[1px] bg-red-500 text-white rounded-sm uppercase text-sm font-medium">
                          Apply
                        </button>
                      </div>
                      <div className="flex justify-between items-center">
                      ...
                      <button
                        onClick={redirect}
                        className="px-5 py-[6px] rounded-sm hover:shadow-orange-500/20 hover:shadow-lg bg-orange-500 text-sm text-black font-medium uppercase"
                      >
