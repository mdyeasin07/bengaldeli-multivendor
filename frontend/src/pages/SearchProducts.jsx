...
const SearchProducts = () => {
  ...
  //const [state, setState] = useState({ values: [799, 1000] });
  ...
  return (
    <div>
      <Headers />
      <section className='bg-[url("http://localhost:3000/images/banner/shop.gif")] h-[300px] mt-6 bg-cover bg-no-repeat relative bg-left '>
                ...
                <div className="py-4 bg-white mb-10 px-3 rounded-md flex justify-between items-start border">
                  ...
                  <div className="flex justify-center items-center gap-3">
                    <select
                      ...
                      className="p-1 border outline-0 text-slate-500 font-semibold"
                      name=""
                      id=""
                    >
